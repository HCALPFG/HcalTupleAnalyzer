...
d_variable_title = {
    "ho_timing"  : "Timing of HO RecHits with muon hit",
    "hbhe_timing": "Timing of HBHE RecHits with muon hit",
    "ho_energy"  : "Energy of HO RecHits with muon hit",
    "hbhe_energy": "Energy of HBHE RecHits with muon hit",
}

d_variable_xaxisTitle = {
    "ho_timing"  : "HO RecHit timing [25 ns]",
    "hbhe_timing": "HBHE RecHit timing [25 ns]",
    "ho_energy"  : "HO RecHit energy [GeV]",
    "hbhe_energy": "HBHE RecHit energy [GeV]",
}

yaxisTitle = "A.U. [unit-normalized]"

hcal_file = r.TFile("output_HcalHPDNoise.root")
dt_file   = r.TFile("output_Cosmics.root")
